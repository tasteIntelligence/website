...
export default function JoinUsContentZH() {
  return (
    <motion.div
      ...
      >
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-900">社区</h3>
          </div>
          <p className="text-sm text-gray-600 mb-4">
            加入小红书群聊，和更多 AI 爱好者一起交流
          </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">加入我们的 Slack 工作区</p>
              </div>
            </div>
            <svg
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">查看我们的开源项目</p>
              </div>
            </div>
            <svg
              className="w-5 h-5 text-gray-400"
